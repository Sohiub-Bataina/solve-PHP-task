...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO watches (watch_name, watch_description, watch_img, watch_price, watch_category, watch_brand, watch_model, strap_material) 
            VALUES (:watch_name, :watch_description, :watch_img, :watch_price, :watch_category, :watch_brand, :watch_model, :strap_material)";
