    ...
    public function login() {
        ...
        if ($user) {
            if (password_verify($this->password, $user['user_password'])) {
                ...
                return "loginErrorMessage.textContent = 'User registered successfully';loginErrorMessage.style.color='green';window.location.href = '../';"; // change the path to the user page
            } else {
